import { Calendar, Trophy, Users, Search } from 'lucide-react-native';

import { HomeShell } from '@/components/home/HomeShell';
import type { QuickAction } from '@/components/home/QuickActions';

const actions: QuickAction[] = [
  { key: 'new', labelKey: 'home.newMatch', fallback: 'طلب مباراة', Icon: Trophy, href: '/(manager)/matches', primary: true },
