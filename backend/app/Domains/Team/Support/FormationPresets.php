...
class FormationPresets
{
    ...
    private static array $presets = [
        ...
        '6v6' => [
            ['key' => '6v6_2_2_1', 'label' => '2-2-1', 'slots' => [
                ['GK', 0.5, 0.08], ['CB', 0.30, 0.32], ['CB', 0.70, 0.32], ['CM', 0.32, 0.58], ['CM', 0.68, 0.58], ['ST', 0.5, 0.82],
            ]],
            ['key' => '6v6_2_1_2', 'label' => '2-1-2', 'slots' => [
                ['GK', 0.5, 0.08], ['CB', 0.30, 0.32], ['CB', 0.70, 0.32], ['CM', 0.5, 0.55], ['ST', 0.32, 0.80], ['ST', 0.68, 0.80],
            ]],
            ['key' => '6v6_3_1_1', 'label' => '3-1-1', 'slots' => [
                ['GK', 0.5, 0.08], ['CB', 0.22, 0.32], ['CB', 0.5, 0.28], ['CB', 0.78, 0.32], ['CM', 0.5, 0.56], ['ST', 0.5, 0.82],
            ]],
            ['key' => '6v6_1_3_1', 'label' => '1-3-1', 'slots' => [
                ['GK', 0.5, 0.08], ['CB', 0.5, 0.30], ['LM', 0.20, 0.55], ['CM', 0.5, 0.52], ['RM', 0.80, 0.55], ['ST', 0.5, 0.82],
            ]],
        ],
        '7v7' => [
        ...
        '9v9' => [
            ['key' => '9v9_3_3_2', 'label' => '3-3-2', 'slots' => [
                ['GK', 0.5, 0.07], ['CB', 0.22, 0.26], ['CB', 0.5, 0.22], ['CB', 0.78, 0.26], ['LM', 0.20, 0.52], ['CM', 0.5, 0.48], ['RM', 0.80, 0.52], ['ST', 0.35, 0.80], ['ST', 0.65, 0.80],
            ]],
            ['key' => '9v9_3_2_3', 'label' => '3-2-3', 'slots' => [
                ['GK', 0.5, 0.07], ['CB', 0.22, 0.26], ['CB', 0.5, 0.22], ['CB', 0.78, 0.26], ['CM', 0.35, 0.50], ['CM', 0.65, 0.50], ['LW', 0.22, 0.76], ['ST', 0.5, 0.82], ['RW', 0.78, 0.76],
            ]],
            ['key' => '9v9_4_3_1', 'label' => '4-3-1', 'slots' => [
                ['GK', 0.5, 0.07], ['LB', 0.16, 0.26], ['CB', 0.38, 0.22], ['CB', 0.62, 0.22], ['RB', 0.84, 0.26], ['CM', 0.28, 0.50], ['CM', 0.5, 0.46], ['CM', 0.72, 0.50], ['ST', 0.5, 0.82],
            ]],
            ['key' => '9v9_3_4_1', 'label' => '3-4-1', 'slots' => [
                ['GK', 0.5, 0.07], ['CB', 0.24, 0.26], ['CB', 0.5, 0.22], ['CB', 0.76, 0.26], ['LM', 0.16, 0.50], ['CM', 0.38, 0.48], ['CM', 0.62, 0.48], ['RM', 0.84, 0.50], ['ST', 0.5, 0.82],
            ]],
        ],
        '11v11' => [
    ...
    {
        return ['5v5', '6v6', '7v7', '8v8', '9v9', '11v11'];
    }
