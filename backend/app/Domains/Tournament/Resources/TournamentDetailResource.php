...
class TournamentDetailResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'first_half_extra_minutes' => $this->first_half_extra_minutes ?? 0,
            'second_half_extra_minutes' => $this->second_half_extra_minutes ?? 0,
            ...
            'foul_rules_enabled' => $this->foul_rules_enabled,
            'player_foul_threshold' => $this->player_foul_threshold,
            'player_penalty_minutes' => $this->player_penalty_minutes,
            'player_foul_repeat' => $this->player_foul_repeat,
            'team_foul_threshold' => $this->team_foul_threshold,
            'team_foul_repeat' => $this->team_foul_repeat,
            'foul_reset_scope' => $this->foul_reset_scope,
