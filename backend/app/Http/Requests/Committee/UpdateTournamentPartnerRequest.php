...
class UpdateTournamentPartnerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'logo' => ['nullable', 'image', 'mimes:jpeg,png,jpg,webp', 'max:' . (int) config('tournament.partners.logo.max_size_kb', 2048)],
