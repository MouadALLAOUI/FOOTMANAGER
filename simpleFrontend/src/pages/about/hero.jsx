...
export default function AboutHero() {
  ...
  const explore = () => {
    document.getElementById('about-who')?.scrollIntoView({ behavior: 'smooth' })
  }
    ...
    <section className="relative flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center px-6 pb-24 pt-36 text-center lg:pt-44">
        ...
        <h1 className="mt-7 text-4xl leading-snug font-black text-white drop-shadow-lg sm:text-5xl md:text-6xl">
          {t('about.hero.title1')}
          <br />
          <span className="text-green-500">{t('about.hero.title2')}</span>
        </h1>
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
          <Link
            to="/register"
            className="btn-ripple flex h-[56px] items-center gap-2.5 rounded-2xl bg-green-500 px-8 text-sm font-bold text-white shadow-[0_16px_40px_rgba(22,163,74,0.45)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-green-400 hover:shadow-[0_22px_55px_rgba(22,163,74,0.6)] active:translate-y-0"
          >
          ...
          <button
            type="button"
            onClick={explore}
            className="flex h-[56px] items-center gap-2.5 rounded-2xl border border-white/25 px-8 text-sm font-bold text-white backdrop-blur-sm transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-green-400 hover:text-green-300 active:translate-y-0"
          >
