      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="flex flex-col items-center justify-between gap-6 rounded-[26px] bg-slate-950 px-8 py-10 ring-1 ring-white/10 lg:flex-row lg:px-12">
          <div className="text-center lg:text-start">
            <h3 className="text-xl font-black text-white">{t('privacy.page.ctaTitle')}</h3>
            <p className="mt-1 text-sm text-slate-400">{t('privacy.page.ctaDesc')}</p>
          </div>
          <Link
            to="/contact"
